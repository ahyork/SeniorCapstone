...
<figcaption>
Mean and standard deviation over a varying number of throws. Each number of throws was tested with 100 simulations. The mean of the data is shown as the point and the standard deviation is represented with the error bars.
</figcaption>
</figure>
